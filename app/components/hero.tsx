    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white dark:bg-[#030303] pt-20">
      ...
      <div className="max-w-7xl mx-auto w-full px-6 lg:px-12 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
          ...
          >
            {/* NEW PRIMARY BUTTON: Download Resume */}
            {resumeUrl && (
              <a
                href={resumeUrl}
                download
                className="inline-flex items-center justify-center gap-2.5 px-8 h-[3.5rem] rounded-2xl bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 hover:-translate-y-0.5 transition-all duration-300 group font-bold"
              >
            ...
            <EnhancedButton variant="secondary" size="xl" href="/contact" className="rounded-2xl px-8 bg-white/50 dark:bg-zinc-900/40 backdrop-blur-md border border-zinc-200 dark:border-zinc-800/80 hover:border-orange-500/40 hover:bg-zinc-100 dark:hover:bg-zinc-800/80 transition-all duration-300">
              Get in Touch
            </EnhancedButton>
          </motion.div>
