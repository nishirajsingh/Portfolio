      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="bg-gradient-to-br from-orange-50/90 to-amber-50/90 dark:from-orange-900/30 dark:to-amber-900/30 backdrop-blur-xl rounded-3xl p-8 border-2 border-orange-300 dark:border-orange-700">
              ...
              <div className="flex justify-center gap-4 mb-8">
                {SOCIAL_LINKS.map((social) => (
                  <motion.a
                    ...
                    className="w-12 h-12 bg-gradient-to-br from-orange-500 to-amber-600 text-white rounded-xl flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200"
                  >
                    <social.icon size={20} />
                  </motion.a>
                ))}
